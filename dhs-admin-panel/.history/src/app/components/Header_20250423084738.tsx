            ...
            <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
                <div className="relative w-full max-w-md">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-gray-100 bg-gray-50 rounded-full focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm"
                    />
                </div>
