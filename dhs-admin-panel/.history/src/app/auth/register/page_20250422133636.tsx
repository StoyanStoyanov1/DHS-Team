...
export default function RegisterPage() {
    ...
    // Add effect to remove the black bar
    useEffect(() => {
        // Function to remove the black bar
        const removeBlackBar = () => {
            // Target potential black bars
            const elementStyles = [
                "position: fixed; bottom: 0px; left: 0px; width: 100%; height: 44px; z-index: 99999; background: rgb(7, 6, 6); color: white; display: flex; align-items: center;",
            ...
            // Also check for elements with black background
        ...
        // Run on mount and with a delay to catch dynamic elements
        removeBlackBar();
        const timer1 = setTimeout(removeBlackBar, 500);
        const timer2 = setTimeout(removeBlackBar, 1500);
    ...
    return (
        <div className="auth-page-container min-h-screen flex items-center justify-center bg-gray-50 p-4">
            ...
            {/* Add hidden overlay to prevent the black bar from showing */}
            <div style={{
                position: 'fixed',
                bottom: 0,
                left: 0,
