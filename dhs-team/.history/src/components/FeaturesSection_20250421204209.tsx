...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, delay = '0s' }) => (
    <div
        className="glassmorphism rounded-xl p-6 hover:shadow-xl transition-all hover:-translate-y-1 duration-300 assemble floating-card space-y-4"
        style={{ animationDelay: delay }}
    >
        <div className="h-12 w-12 rounded-lg bg-blue-purple-gradient flex items-center justify-center text-white mb-4">
            {icon}
        </div>
...
const FeaturesSection: React.FC = () => {
    ...
    return (
        <section id="features" className="py-20 relative">
            <div className="blurred-circle bg-purple-500/20 h-72 w-72 -bottom-10 -left-10"></div>
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="relative mb-24 reveal">
                    ...
                    <div className="relative glassmorphism rounded-2xl p-6 shadow-xl border border-white/30 floating-card">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 stagger-children">
                            {/* Update the first four feature cards with improved styling */}
                            <div className="glassmorphism rounded-xl p-4 flex items-center gap-4 hover:shadow-md transition-shadow">
                                ...
                                <div>
                                    <h3 className="font-medium">AI Асистент</h3>
                                    <p className="text-sm text-muted-foreground">Интелигентен чат бот</p>
                                </div>
                            </div>
                            ...
                            <div className="glassmorphism rounded-xl p-4 flex items-center gap-4 hover:shadow-md transition-shadow">
                                ...
                                <div>
                                    <h3 className="font-medium">Софтуерна разработка</h3>
                                    <p className="text-sm text-muted-foreground">Персонализирани решения</p>
                                </div>
                            </div>
                            ...
                            <div className="glassmorphism rounded-xl p-4 flex items-center gap-4 hover:shadow-md transition-shadow">
                                ...
                                <div>
                                    <h3 className="font-medium">Бързо внедряване</h3>
                                    <p className="text-sm text-muted-foreground">Оптимизиран процес</p>
                                </div>
                            </div>
                            ...
                            <div className="glassmorphism rounded-xl p-4 flex items-center gap-4 hover:shadow-md transition-shadow">
                                ...
                                <div>
                                    <h3 className="font-medium">Поддръжка</h3>
                                    <p className="text-sm text-muted-foreground">24/7 обслужване</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="text-center mb-12 reveal">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">Нашите <span className="text-gradient">услуги</span></h2>
